"""
Django settings for hidden_star_40188 project.
...
ROOT_URLCONF = 'hidden_star_40188.urls'
...
WSGI_APPLICATION = 'hidden_star_40188.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "hidden_star_40188 API",
    "DESCRIPTION": "API documentation for hidden_star_40188 App",
    "VERSION": "v1",
}
